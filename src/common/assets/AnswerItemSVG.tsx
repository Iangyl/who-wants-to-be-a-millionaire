...
import { IAnswerItemSVG } from './index.types';

const SVGComponent: React.FC<IAnswerItemSVG> = ({
  width,
  height,
  color = '#D0D0D8',
}) => (
...
const AnswerItemSVG = React.memo(SVGComponent);
export default AnswerItemSVG;
